...
\includepdf[pages={1-8}]{KI_ChangeManagement_DE_fr_ru_en_without.pdf}
...
\includepdf[pages={1-5}]{KI_ChangeManagement_DE.pdf}

\subsection{Zwischenübersetzungen}\label{sec:zwischenuebersetzung}

\includepdf[pages={1-5}]{KI_ChangeManagement_DE_fr_without.pdf}
\includepdf[pages={1-7}]{KI_ChangeManagement_DE_fr_ru_without.pdf}
